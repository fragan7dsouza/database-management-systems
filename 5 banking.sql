...
INSERT INTO ACCOUNT VALUES (98765, 'synd_nitte', 7000)
...
INSERT INTO DEPOSITOR VALUES ('Rakesh', 98765)
...
select * from depositor D , account A where D.accno = A.accno and D.cname = 'rakesh'
select * from depositor D , account A where D.accno = A.accno and D.cname = 'John smith'
select * from customer
